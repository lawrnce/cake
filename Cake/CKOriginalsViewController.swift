//
//  CKOriginalsViewController.swift
//  Cake
//
...
class CKOriginalsViewController: UIViewController {
...
extension CKOriginalsViewController: UICollectionViewDataSource {
...
extension CKOriginalsViewController: UICollectionViewDelegate {
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName(ShowOriginalDetail, object: gifURL)
